// Generated by @wagmi/cli@0.1.15 on 4/16/2023 at 2:08:36 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const challengeFactoryABI = [
  ...
  },
  {
    ...
    outputs: [
      { name: '', internalType: 'contract Challenge', type: 'address' },
    ],
  },
  {
    stateMutability: 'view',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link challengeFactoryABI}__ and `functionName` set to `"activeChallenges"`.
 */
export function useChallengeFactoryActiveChallenges<
